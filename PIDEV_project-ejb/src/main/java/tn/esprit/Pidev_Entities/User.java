...
public class User implements Serializable{ 
	...
	@OneToMany(mappedBy = "user")	
	@JsonBackReference
	private List<formationEnLigne> formationEnLign;
	@OneToMany(mappedBy = "users")
	@JsonBackReference
	private List<affectationEnLigne> affectationEnLigne;
	...
	public List<formationEnLigne> getFormationEnLign() {
		return formationEnLign;
	}
	public void setFormationEnLign(List<formationEnLigne> formationEnLign) {
		this.formationEnLign = formationEnLign;
	}
	public List<affectationEnLigne> getAffectationEnLigne() {
		return affectationEnLigne;
	}
	public void setAffectationEnLigne(List<affectationEnLigne> affectationEnLigne) {
		this.affectationEnLigne = affectationEnLigne;
	}
	...
	// Relation entre employe et reclamation
	@OneToMany(mappedBy = "user")	
	@JsonBackReference
